document.addEventListener('DOMContentLoaded', function() {
    ...
    const fullText = "Hej det är Karin Fahlén, bibliotekarie på Orkanen! Jag behöver er hjälp! Någon har stulit boken “Alla världens fjärilar”.";
    ...
    function showTextContinuously() {
        const intervalTime = (audio.duration / words.length * 900) || 200; // Beräkna tid per ord, default till 200ms om duration är 0
